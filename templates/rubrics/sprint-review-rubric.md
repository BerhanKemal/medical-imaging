...
| Score | Descriptor |
|-------|------------|
| 23-25 | All sprint goals met. Every planned user story is done and meets the Definition of Done. |
...
- Review the team's GitHub repository, project board, and PR history **before** the review session.
- Each review session should last approximately **15-20 minutes** per team (10 min demo + 5-10 min Q&A and retrospective).
- Provide **written feedback** alongside the numeric score so the team can improve in subsequent sprints.
- If a team member is absent without prior notice, deduct up to 5 points from the Teamwork criterion.
